...
/**
  *
  */
class DUOperation implements DUConstants
{
...
//    public String   redirectPath;
    ...
    public String toString() {
        ...
        sb.append("{").append(fileID).append(",").
            append(OP_DESCRIPTIONS[operation]).append(",").
            append(localDescription).append(",").
            append(localPath).append(",").
            append(localSize).append(",").
            append(localVersion).append(",").
            append(remoteVersion).append(",").
            append(remotePath).append(",").
            append(remoteSize).append(",").
            append(remoteDescription).append("}");
        return sb.toString();
    }
}
